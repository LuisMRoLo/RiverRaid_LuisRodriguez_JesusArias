...
public class MenuInicial extends Estados implements InterfacesVentana{
    ...
    public void onEnter() { 
        ...
        Titulo.setLocation(InterfacesVentana.width / 2 - Titulo1.getIconWidth() / 3 ,20);
        ...
        cargarBTN.setLocation(InterfacesVentana.width / 2 + cargar.getIconWidth() / 2, 200);
        ...
        iniciarBTN.setLocation(InterfacesVentana.width / 2 + iniciar.getIconWidth() / 2 , 200 + cargar.getIconHeight() + 10);
        ...
        aiudaBTN.setName("a");
        aiudaBTN.setLocation(InterfacesVentana.width / 2 + aiuda.getIconWidth() / 2 , 200 + cargar.getIconHeight() + iniciar.getIconHeight() + 10 + 10);
        ...
        creditosBTM.setLocation(InterfacesVentana.width / 2 + creditos.getIconWidth() / 2, 200 + creditos.getIconHeight() + creditos.getIconHeight() + iniciar.getIconHeight() + 10 + 10 + 10);
        ...
        exitBTN.setName("e");
        exitBTN.setLocation(InterfacesVentana.width / 2 + exit.getIconWidth() / 2 , 200 + aiuda.getIconHeight() + cargar.getIconHeight() + iniciar.getIconHeight() + iniciar.getIconHeight() + 10 + 10 + 10 + 10);
    ...
    class ActionClick implements MouseListener{
        ...
        public void mouseEntered(MouseEvent e) {
            if(e.getComponent().getName().equals("c")){ //cargar partida
                ...
                cargarBTN.setLocation(InterfacesVentana.width / 2 + cargar1.getIconWidth() / 2, 200);
                cargarBTN.setFocusable(false);
                cargarBTN.setVisible(true);
                teclas.Boton();
            }
            if(e.getComponent().getName().equals("i")){
                ...
                iniciarBTN.setLocation(InterfacesVentana.width / 2 + iniciar1.getIconWidth() / 2, 200 + cargar.getIconHeight() + 10);
            ...
            if(e.getComponent().getName().equals("a")){
                ...
                aiudaBTN.setLocation(InterfacesVentana.width / 2 + aiuda1.getIconWidth() / 2, 200 + cargar1.getIconHeight() + iniciar.getIconHeight() + 10 + 10);
            ...
            if(e.getComponent().getName().equals("r")){
                ...
                creditosBTM.setLocation(InterfacesVentana.width / 2 + creditos1.getIconWidth() / 2, 200 + creditos1.getIconHeight() + creditos1.getIconHeight() + iniciar1.getIconHeight() + 10 + 10 + 10);
            ...
            if(e.getComponent().getName().equals("e")){
                ...
                exitBTN.setLocation(InterfacesVentana.width / 2 + exit1.getIconWidth() / 2, 200 + aiuda1.getIconHeight() + cargar1.getIconHeight() + iniciar1.getIconHeight() + iniciar1.getIconHeight() + 10 + 10 + 10 + 10);
        ...
        public void mouseExited(MouseEvent e) {
            ...
            if(e.getComponent().getName().equals("i")){
                iniciarBTN.setIcon(iniciar);
                iniciarBTN.setLocation(InterfacesVentana.width / 2 + iniciar.getIconWidth() / 2, 200 + iniciar.getIconHeight() + 10);
                iniciarBTN.setSize(iniciar.getIconWidth(), iniciar.getIconHeight());
                iniciarBTN.setFocusable(false);
                iniciarBTN.setVisible(true);
            ...
            if(e.getComponent().getName().equals("a")){
                aiudaBTN.setIcon(aiuda);
                aiudaBTN.setLocation(InterfacesVentana.width / 2 + aiuda.getIconWidth() / 2, 200 + aiuda.getIconHeight() + iniciar.getIconHeight() + 10 + 10);
                aiudaBTN.setSize(aiuda.getIconWidth(), aiuda.getIconHeight());
                aiudaBTN.setFocusable(false);
                aiudaBTN.setVisible(true);
            }
