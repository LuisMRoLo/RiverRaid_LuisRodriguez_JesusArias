...
import interfaces.*;
import juego.Game;
import juego.InterfacesVentana;


public class Instrucciones extends Estados{
    Game world;
    ...
    public Instrucciones(Game world) {
        this.world=world;
    ...
    public void onEnter() {
        ...
        comoJugarB.setLocation(InterfacesVentana.width / 2 - comoJugar.getIconWidth() / 2 ,20);
        ...
        fondAyudaB.setLocation(InterfacesVentana.width / 2 - fondAyuda.getIconWidth() / 2 ,10);
        ...
        volverB.setLocation(InterfacesVentana.width / 3 - volver.getIconWidth(), 600);
        ...
        botonNextB.setLocation(InterfacesVentana.width / 2 + botonNext.getIconWidth() , 600);
    ...
    class ActionClick implements MouseListener{
        ...
        public void mouseEntered(MouseEvent e) {
            if(e.getComponent().getName().equals("v")){
                ...
                volverB.setLocation(InterfacesVentana.width / 3 - volver1.getIconWidth(), 600);
                volverB.setFocusable(false);
                volverB.setVisible(true);
                teclas.Boton();
            }  
            if(e.getComponent().getName().equals("n")){
                ...
                botonNextB.setLocation(InterfacesVentana.width / 2 + botonNext1.getIconWidth() , 600);
                botonNextB.setFocusable(false);
                botonNextB.setVisible(true);
                teclas.Boton();
            }
