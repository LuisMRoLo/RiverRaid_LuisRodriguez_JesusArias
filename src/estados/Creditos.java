...
public class Creditos extends Estados{
    Game world;
    ...
    public void onEnter() {
        ...
        titCreditosB.setLocation(460 ,10);
        ...
        fondCreditosB.setLocation(InterfacesVentana.width - fondCreditos.getIconWidth() ,10);
    ...
    class ActionClick implements MouseListener{
        ...
        public void mouseEntered(MouseEvent e) {
            if(e.getComponent().getName().equals("v")){
                ...
                volverB.setLocation(InterfacesVentana.width / 2 - volver1.getIconWidth() / 2, 600);
                volverB.setFocusable(false);
                volverB.setVisible(true);
                teclas.Boton();
            } 
