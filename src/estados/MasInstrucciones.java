...
public class MasInstrucciones extends Estados{
    Game world;
    ...
    public MasInstrucciones(Game world) {
        this.world=world;
    ...
    public void onEnter() {
        ...
        comoJugarB.setLocation(InterfacesVentana.width / 2 - comoJugar.getIconWidth() / 2 ,10);
        ...
        botonVolverB.setLocation(InterfacesVentana.width / 2 - botonVolver.getIconWidth() / 2 , 600);
    ...
    class ActionClick implements MouseListener{
        ...
        public void mouseEntered(MouseEvent e) {
            if(e.getComponent().getName().equals("v")){
                ...
                botonVolverB.setLocation(InterfacesVentana.width / 2 - botonVolver1.getIconWidth() / 2, 600);
                botonVolverB.setFocusable(false);
                botonVolverB.setVisible(true);
                teclas.Boton();
            }         
