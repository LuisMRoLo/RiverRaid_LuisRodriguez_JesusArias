...
public class MenuUsuario extends Estados {
    ...
    public MenuUsuario(Game world) {
        this.world=world;
        text.setBounds(InterfacesVentana.width/2 - 100, 150, 200, 20);
        text.addKeyListener(new Teclado());
        teclas = new Sonidos();
        Titulo.setFont(fuente);
        TituloN.setFont(fuente2);
        Titulo.setBounds(InterfacesVentana.width / 2 - InterfacesVentana.heigth / (5/2), 160, 800, 100);
    ...
    class Teclado extends KeyAdapter{
        ...
        public void keyTyped(KeyEvent e) {
            ...
            if(text.getText().length()>1 && e.getKeyCode()!=KeyEvent.VK_ENTER){
                ...
                enterB.setLocation(InterfacesVentana.width / 2 - enter.getIconWidth() / 2, 70);
